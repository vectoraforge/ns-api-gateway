...
class TestEveryOutcomeFromTheClaimOnwardConsumesExactlyOnce:
    ...
    def test_a_registered_claimant_is_refused_and_still_consumes(self, client, challenges_db, account,
                                                                  devicecheck):
        identity_row, _ = account
    ...
    def test_a_spent_lifetime_slot_is_refused_and_still_consumes(self, client, challenges_db, account,
                                                                  grants, devicecheck):
        identity_row, _ = account
    ...
    def test_the_repeat_answers_two_hundred_and_still_consumes(self, client, challenges_db, account,
                                                               grants, devicecheck):
    ...
    def test_a_spent_device_slot_is_refused_and_still_consumes(self, client, challenges_db, account,
                                                               grants, devicecheck):
        identity_row, _ = account
        challenges_db.row = _issued_row(bound_to=identity_row.id)
    ...
    def test_the_race_loser_answers_two_hundred_and_still_consumes(self, client, challenges_db, account,
                                                                    grants, devicecheck):
    ...
    def test_a_race_lost_to_another_source_is_the_refusal_the_preflight_gives(
            self, client, challenges_db, account, grants, devicecheck, monkeypatch):
    ...
    def test_the_refusal_names_the_writer_s_arm_in_its_one_log_line(self, client, challenges_db, account,
                                                                     grants, devicecheck,
                                                                     monkeypatch):
    ...
    def test_the_successful_claim_consumes_exactly_once(self, client, challenges_db, account, grants,
                                                        devicecheck):
        identity_row, _ = account
        challenges_db.row = _issued_row(bound_to=identity_row.id)
    ...
    def test_the_writer_is_told_which_attestation_this_route_ran(self, client, challenges_db, account,
                                                                 grants, devicecheck):
...
class TestTheDeviceReadAndTheDeviceWriteNameOneDevice:
    ...
    def test_the_token_the_gate_reads_is_the_token_it_then_writes(self, client, challenges_db, account,
                                                                   grants, devicecheck):
        identity_row, _ = account
        challenges_db.row = _issued_row(bound_to=identity_row.id)
    ...
    def test_a_body_naming_no_device_is_rejected_before_the_gate(self, client, challenges_db,
                                                                 account, devicecheck):
    ...
    def test_a_body_offering_a_second_token_never_reaches_the_gate_with_it(self, client, challenges_db,
                                                                           account, devicecheck):
...
class TestNoVendorCallHappensUnderALockOrInsideTheTransaction:
    ...
    def test_the_claims_commit_precedes_the_seam_and_no_transaction_is_open_during_it(
            self, client, challenges_db, account, session, devicecheck, timeline):
