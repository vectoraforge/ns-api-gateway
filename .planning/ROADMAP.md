...
**Plans:** 8/9 plans executed — 5/5 executed, then 4 gap-closure plans (45-06 … 45-09) added 2026-09-08 to close the three blocker gaps `45-VERIFICATION.md` found
**Success criteria:**
...
| 45. POST /auth/restore-subscription | v2.0 | 8/9 | In Progress|  |
