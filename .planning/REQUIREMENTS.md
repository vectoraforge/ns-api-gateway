...
| FOUND-01 … FOUND-08 | Phase 35 | Pending (FOUND-01/02 amended; FOUND-05 withdrawn; one further requirement deleted outright — all by Phase 37.1, see the FOUND block; FOUND-08 amended and flagged forward to phases 43–46 by Phase 37.2) |
...
**Standing after Phase 37.1's two deletions (2026-08-24) and Phase 37.2's auth-module simplification (2026-08-25):**
...
| Amended, substance intact | Phase 37.1: FOUND-01, FOUND-02, REBIND-01, REBIND-02, PROF-02, APPLEHOOK-01, FOUND-09. Phase 37.2: **CREATE-01**, **CREATE-02**, **FOUND-08** |
| Flagged forward — the owning phase decides | Phase 37.1: SYNC-03 (38), SIGNOUT-02 (46), APPLEHOOK-02 (43), PLAYHOOK-03 (44). Phase 37.2: FOUND-08's adapter seam → 43, 44, 45 and 46, each defining its interface beside its first implementation |
...
*Last updated: 2026-08-25 — amended by Phase 37.2 plan 07 for the challenge-route split, the ADC-only credential path, and the adapter-interface deletions*
